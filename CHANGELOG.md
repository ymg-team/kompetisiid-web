...
- competition detail - add hashtag generator on competition detail (yussan)
...
- **browse competition:** bug on not found data in search ([00bbd5a](https://github.com/idmore/kompetisiid-web/commit/00bbd5a)), closes [#75](https://github.com/idmore/kompetisiid-web/issues/75)
...
- **modal:** hidden scroll when show modal ([f996650](https://github.com/idmore/kompetisiid-web/commit/f996650)), closes [#72](https://github.com/idmore/kompetisiid-web/issues/72)
...
- **slider:** make indicator on position relative ([a6feecd](https://github.com/idmore/kompetisiid-web/commit/a6feecd))
...
- **wrong modal in competition detail:** solving ([bc0e48f](https://github.com/idmore/kompetisiid-web/commit/bc0e48f)), closes [#40](https://github.com/idmore/kompetisiid-web/issues/40)
...
- **design:** new layout ([e3e20b2](https://github.com/idmore/kompetisiid-web/commit/e3e20b2))
- **detail post:** addded link parser ([b2d9958](https://github.com/idmore/kompetisiid-web/commit/b2d9958))
- **exit page:** added exit page if acces other website from ki ([2deddaf](https://github.com/idmore/kompetisiid-web/commit/2deddaf))
- **filter browse:** added filter condition ([43e4642](https://github.com/idmore/kompetisiid-web/commit/43e4642))
- **homepage:** added new slider - stats - categories home design ([6007b02](https://github.com/idmore/kompetisiid-web/commit/6007b02))
- **news list:** added news list filter by tag ([39e9209](https://github.com/idmore/kompetisiid-web/commit/39e9209))
- **ready for deply:** test build ([d5b70ab](https://github.com/idmore/kompetisiid-web/commit/d5b70ab))
- **styled-component:** implementation of styled component ([94365e5](https://github.com/idmore/kompetisiid-web/commit/94365e5))
