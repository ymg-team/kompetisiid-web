...
router.post("/:seal", sealMiddleware, requestMiddleware.post, controller.create, apiCaller)
router.put("/:id/:seal", sealMiddleware, requestMiddleware.post, controller.update, apiCaller)
router.get(
  "/related/:id/:seal",
  sealMiddleware,
