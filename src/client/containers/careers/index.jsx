...
const Index = () => (
    <div>
        ...
        <div className='col-md-12 careers-header' style={{textAlign: 'center', backgroundImage:'url(/assets/4.2/img/careers-background.jpg)'}}>
            ...
            <h1>Mari Berkarir Bersama KI</h1>
            <h3>Kompetisi.id adalah salah satu produk dari ByIdMore yang sama-sama bertujuan untuk melakukan lebih untuk Indonesia. Mari bergabung bersama kami untuk terus meramaikan semangat kompetisi di Indonesia.<br />Kami sedang mencari jiwa-jiwa bertalenta untuk menjadi bagian dari KI yang memiliki bagian sebagai berikut.</h3><a className='btn btn-white btn-bg' href='#available-careers' style={{fontWeight: 'bold'}}>Telusuri Lowongan Tersedia <i className='fa fa-arrow-circle-o-down'> </i></a></div>
        </div>

        <div className="col-md-8 col-md-push-2 m-t-b-20 align-center careers" style={{lineHeight: 2}}>
            ...
            <div className="col-md-12">
                ...
                <ul className="align-left">
                    ...
                    <li>Terbiasa menggunakan dependensi pendukung dari<i>NPM</i>, atau<i>tool-tool</i>untuk<i>development</i>seperti<i>Grunt, Prepack, Webpack, dll</i></li>
                    <li>Kami menggunakan<i>git</i>sebagai<i>version control system</i></li>
                </ul>
                ...
                <ul className="align-left">
                    ...
                    <li>Kami menggunakan<i>Firebase, Mailgun, Dlvrt, dsb</i>sebagai <i>3th party </i>yang diakses beberapa<i>micro services </i>KI</li>
                    <li>Kami menggunakan<i>git</i>sebagai<i>version control system</i></li>
                </ul>
                <button className="btn btn-gray btn-sm" disabled="true">Pendaftaran Belum Dibuka</button>
                </div>
            ...
            <div className="col-md-12">
                <h2>Technical Support</h2></div>
            <div className="col-md-6 carrers-item"><strong>DevOops</strong>
                <ul className="align-left">
                <li>Linux based server</li>
                <li>Docker </li>
                <li> <i>3th party </i>seperti <i>Gitlab Enterprise, Firebase, Heroku, dsb</i></li>
            ...
            <div className="col-md-6 carrers-item">
                <div className="disabled" /><strong>Web QA Engineer</strong></div>
            </div>
            <div className="col-md-12 m-t-b-10">
            <hr />
            </div>
            ...
            <div className="col-md-6 carrers-item">
                <div className="disabled" /><strong>Marketing Staff</strong></div>
            <div className="col-md-6 carrers-item">
                <div className="disabled" /><strong>Production Executive</strong></div>
            </div>
            <div className="col-md-12 m-t-b-10">
            <hr />
            </div>
            ...
            <div className="co-md-12">
                ...
                <br />
                <a className="btn btn-green" href="https://goo.gl/forms/kMGGZQXJCjoyKThj1" target="_blank"> <strong>Kontak Kami</strong></a>
                <br />
