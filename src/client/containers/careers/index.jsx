        ...
        >
          <div className="container">
            ...
            <h3>
              ...
              bersama kami untuk terus meramaikan semangat kompetisi di
              Indonesia.<br />Kami sedang mencari jiwa-jiwa bertalenta untuk
              menjadi bagian dari KI yang memiliki bagian sebagai berikut.
            </h3>
            <a
            ...
            <div className="col-md-12">
              ...
              <div className="col-md-6 carrers-item">
                ...
                <ul className="align-left">
                  ...
                  <li>
                    Terbiasa menggunakan dependensi pendukung dari<i>NPM</i>,
                    atau<i>tool-tool</i>untuk<i>development</i>seperti<i>
                      Grunt, Prepack, Webpack, dll
                    </i>
                  </li>
                  <li>
                    Kami menggunakan<i>git</i>sebagai<i>
