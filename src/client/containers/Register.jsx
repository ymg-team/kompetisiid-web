        ...
        return(
            <div className="container">
                ...
                <div className="col-md-5">
                    <div className="login-box">
                        <form method="POST" action="javascript:;">
                            ...
                            <Input
                                ...
                                changeState={(key, val) => this.changeState(key, (key === 'username' ? val.replace(/\s/g, '') : val))}
                            />
                            <Input
                                label="email."
                                type="email"
                            ...
                            <div className="checkbox">
                                <label>
                                    <input onChange={this.handleChangeAccept.bind(this)} type="checkbox" defaultValue="ingat saya" />
                                    Saya menyetujui <a target="_blank" href="/">syarat dan ketentuan</a>
                                </label>
                            </div>
                            <br />
                            <button
                            ...
                            <div className="text-center">
                                <small className="text-muted">sudah punya akun silahkan
                                    {' '}
                    ...
                    {/*</div>*/}
                    <div className="text-center"><small className="white-text">Kompetisi copyright © Id More 2016</small></div>
                </div>
            </div>
        )
    }
