    ...
    <div id='competition-detail' className='row no-margin p-50-0'>
      <div className='col-md-12'>
        <div className='container'>
          <div className='competition-author'>
            ...
            <p>
              dipasang oleh <Link className='text-muted'
                                  to={`/user/${data.author.username}`}>{data.author.username}</Link>
              <br/>
          ...
          <div className='row competition-detail--meta'>
            ...
            <div className='col-md-6 count'>
              ...
              <div style={{marginBottom: '20px'}}>
                {
                  data.sisadeadline == 'berakhir' && data.sisapengumuman == 'berakhir' ?
                    ...
                    : data.sisadeadline == 'berakhir' && data.sisapengumuman != 'berakhir' ?
                    <span title={`Pengumuan pemenang dalam ${data.sisapengumuman}`}
              ...
              <a style={{marginRight: '10px'}}
                 onClick={() => fullalert('warning', 'login terlebih dahulu untuk menyimpan')} className='btn btn-white'
                 href='javascript:;' title='simpan ke akun'><i className='fa fa-save'/></a>
              <a style={{marginRight: '10px'}} onClick={() => {
                modal('open', 'save-to-calendar')
              }} className='btn btn-white' href='javascript:;' title='simpan ke kalender'><i
                className='fa fa-calendar'/></a>
              <div className='dropdown'>
                ...
                <div className='dropdown-items' id='action-competition'>
                  <ul>
                    <li><a className='scopy-button' onClick={() => handleCopyLink(link_competition)} target='_blank'
                           href='javascript:;'>Copy Link</a></li>
                    <li><a target='_blank'
                           href={`https://docs.google.com/forms/d/e/1FAIpQLSdmsHkJdGctVkWYFhhLC10YYVbtNIi5IF8X0mbdd2DjS-N1eQ/viewform?entry.559533126=${link_competition}`}>Laporkan
                      Kompetisi</a></li>
                  </ul>
                </div>
              </div>
      ...
      <div className='modal' id='save-to-calendar'>
        <div className='container'>
          ...
          <a onClick={() => fullalert('warning', 'untuk sekarang, kalender Microsoft untuk saat ini belum tersedia')}
             href='javascript:;'>
