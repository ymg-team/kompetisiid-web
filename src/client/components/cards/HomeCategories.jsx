  ...
  render() {
    return (
      <div className='col-md-12'
           style={{borderTop: '1px solid gray', borderBottom: '1px solid gray', padding: '3em 0'}}>
            ...
            <div className='row'>
              {
                this.props.meta && this.props.meta.code == 200 ?
                  this.props.data.map((n, key) => (
                    <span style={{marginRight: '10px'}} key={key}><Link
                      to={`/browse/${n.main_kat}`}>{`${n.main_kat}(${n.count_kompetisi})`}</Link></span>
                  ))
                  : null
              }
              <br/>
