        ...
        return(
            <nav>
                <div style={{top: q ? '-50px' : '0px'}} className='nav-header'>
                    ...
                    <div className='nav-right'>
                        <ul className='top-menu'>
                            <li>
                                <a id='btn-search' href='javascript:;' title='click untuk melakukan pencarian'> <span className='fa fa-search' /></a>
                            </li>
                            {
                                session && session.meta && session.meta.code == 201 ?
                                <li>
                                    <div className='dropdown'>
                                        <a className='avatar' href='javascript:;'>
                                            <img className='dropdown-button' src='/assets/4.2/img/avatar-default.jpg' data-target='avatar-menu'/>
                                        </a>
                ...
                <div className='nav-search'>
                    ...
                    <a id='btn-closesearch' onClick={() => {if(q != '') return window.location.href='/browse'}} href='javascript:;' title='tutup pencarian'> <span className='fa fa-close' /></a>
                </div>
            </nav>
        )
    }
