        ...
        <div className="container">
          <div className="row">
            <div className="col-md-6">
              ...
              'KI'. Dipersembahkan oleh ID More. Penyelenggara dapat menggunakan
              KI sebagai media publikasi, media partner ataupun kerja sama untuk
              kompetisi yang mereka adakan. Peserta dapat menjelajahi dan
              mengikuti berbagai kategori kompetisi di KI dan semoga menjadi
              pemenang.
            </div>
